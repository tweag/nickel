...
/// Call to the Nix FFI to evaluate the given Nix code and return the result as a JSON string.
/// `base_dir` is the base directory passed to the Nix evaluator, which is used to resolve imports
/// on the Nix side.
