...
use crate::{
    bytecode::value::{
        self, Array, ArrayBody, EnumVariantBody, NickelValue, TypeBody, ValueContent,
        lens::TermContent, ValueContentRef, RecordBody
    },
    cache::InputFormat,
    combine::Combine,
...
impl Traverse<NickelValue> for NickelValue {
    ...
    fn traverse_ref<S, U>(
        ...
        match self.content_ref() {
            ValueContentRef::Array(array_data) => array_data.array.iter().find_map(|t| t.traverse_ref(f, state)),
