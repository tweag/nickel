...
use crate::{
    ...
    term::{
        ...
        RecordInsertData, RecordOpKind, RichTerm, Term, UnaryOp,
    },
};
...
fn update_with_merge(record_id: LocIdent, id: LocIdent, field: Field) -> RichTerm {
    ...
    let singleton = Term::Record(Box::new(RecordData {
            ...
            TailPattern::Empty => make::if_then_else(
                make::op1(
                    ...
                    make::op2(
                        ...
                        Term::Record(Box::new(RecordData::empty())),
                    ),
                ),
                Term::Null,
...
impl Compile for MatchData {
    ...
    fn compile(mut self, value: RichTerm, pos: TermPos) -> RichTerm {
        ...
        let error_case = RichTerm::new(
            Term::RuntimeError(Box::new(EvalError::NonExhaustiveMatch {
                value: value.clone(),
                pos,
            })),
            pos,
...
impl Compile for TagsOnlyMatch {
    fn compile(self, value: RichTerm, pos: TermPos) -> RichTerm {
        ...
        let match_op = mk_app!(
            ...
            .with_pos(pos),
            Term::Record(Box::new(RecordData::with_field_values(
