...
type CBNClosure = Closure<CBNCache>;
...
impl ThunkData {
    ...
    pub fn new_rev(orig: CBNClosure, deps: FieldDeps) -> Self {
        let rc = Rc::new(orig);
...
impl Thunk {
    ...
    pub fn new_rev(closure: CBNClosure, ident_kind: IdentKind, deps: FieldDeps) -> Self {
        Thunk {
