...
//    bench("fold normal 100", "lists/fold", None, 100, EvalMode::Normal, c);
//}
//
//fn fold_deepseq(c: &mut Criterion) {
//    bench("fold deepseq 100", "lists/fold", None, 100, EvalMode::DeepSeq, c);
//}

fn generate_normal(c: &mut Criterion) {
    bench("generate normal 50", "lists/generate", None, 50, EvalMode::Normal, c);
}

fn generate_deepseq(c: &mut Criterion) {
    bench("generate deepseq 50", "lists/generate", None, 50, EvalMode::DeepSeq, c);
}

// Waiting for the lists stdlib
// fn map_normal(c: &mut Criterion) {
//     bench("map normal 100", "lists/map", None, 100, EvalMode::Normal, c);
// }
//
// fn map_deepseq(c: &mut Criterion) {
//     bench("map deepseq 100", "lists/map", None, 100, EvalMode::DeepSeq, c);
// }

//fn pipe_normal(c: &mut Criterion) {
//    bench("pipe normal 50", "lists/pipe", None, 50, EvalMode::Normal, c);
//}
//
//fn pipe_deepseq(c: &mut Criterion) {
//    bench("pipe deepseq 50", "lists/pipe", None, 50, EvalMode::DeepSeq, c);
//}
