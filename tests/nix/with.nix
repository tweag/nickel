...
[
  ...
  # TODO: this test is disabled because, now, when we are in a rec record, we don't populate the environment with it's fields. See how it's done for `let in` blocks.
  #  (
  #    with r1; rec {
  #      a = 11;
  #      v =  a + 11;
