...
impl<'input> Lexer<'input> {
    ...
    fn handle_normal_token(
        ...
        match token {
            ...
            NormalToken::Error => return Some(Err(LexicalError::Generic(span))),
            _ => (),
        };
    ...
    fn handle_string_token(
        ...
        let result = match token {
            ...
            StringToken::Error => return Some(Err(LexicalError::Generic(span))),
    ...
    fn handle_multistr_token(
        ...
        let result = match token {
            ...
            MultiStringToken::Error => return Some(Err(LexicalError::Generic(span))),
