...
//!
//! ```rust
//! # use nickel_lang_core::ast::{record::MergePriority, Ast, Node, builder::Record, AstAlloc};
//!
...
impl<'ast> Record<'ast> {
    ...
    /// Finalize the record and turn it into a [`crate::ast::Ast`]
